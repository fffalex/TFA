...
angular.module('tfaApp')
  .controller('TeacherUniteditCtrl', function ($scope,close,topic,unitsrv) {
      ...
      $scope.htmlcontent = $scope.currentTopic.content;
      ...
      $scope.saveEditedTopic = function () {
          $scope.currentTopic.content = $scope.htmlcontent;
